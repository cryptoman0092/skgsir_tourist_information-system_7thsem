...
if(count($_POST)!=0){
    extract($_POST);
    $query="INSERT INTO travels(user,date,travelm,source,destination,price)
     values('$user','$bdate','$travelm','$source','$destination', '$price')";
...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <form action="#" method="POST" name="travelform">
     ...
     <div>
        ...
        <div>
            <button type="submit" class="buttonsbt" name="submit" >Order now </button>
        </div>
       <br>
