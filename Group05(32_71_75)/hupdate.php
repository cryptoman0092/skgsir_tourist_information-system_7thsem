...
if(count($_POST)!=0){
    extract($_POST);
    extract($_GET);  
    $query=" UPDATE hotels SET hname='$hname', person='$person', cdate='$cdate',
    odate='$odate' WHERE user='$user'  ";
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    id="profilepic">
    <h2 class="user"> UPDATE BOOKING</h2>
  <form action="" method="POST" name="hotelform">
        ...
        <div>
             <button type="submit" name="update" class="buttonsbt" >Update Booking </button>
        </div>
       <br>
